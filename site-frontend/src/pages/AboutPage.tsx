...
export default function AboutPage() {
  ...
  return (
    <div className="content">
      ...
      <section>
        <p>
          Подкаст "Цинковый прод" - это подкаст про разработку, тимлидство и прочее IT в развлекательно-познавательном формате. Чаще всего наши выпуски напоминают разговоры в офисе за обедом или в курилке. Мат-перемат, ржачка, но и польза тоже есть.
